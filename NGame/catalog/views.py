...
def view_cart(request):
    ...
    return render(request, 'site/cart.html', {'cart': cart, 'items': items, 'cart_count': cart_count, 'price': total_price})
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('index')
    return render(request, 'site/checkout.html', {'cart': cart, 'items': items})